...
const document_grid_component_1 = require("../document-grid/document-grid.component");
let DashboardComponent = (() => {
    let _classDecorators = [(0, core_1.Component)({
            selector: 'app-dashboard',
            standalone: true,
            imports: [common_1.CommonModule, document_grid_component_1.DocumentGridComponent],
    ...
    var DashboardComponent = _classThis = class {
        ...
        constructor(router, http) {
            ...
            this.username = "admin";
            this.password = "admin";
            this.loadedPages = new Set(); // Track loaded pages
            this.allLoaded = false;
        }
        createNewDoc() {
            this.router.navigate(['/editor', Math.random()]);
        }
        openDoc(id) { this.router.navigate(['/editor', id]); }
    };
