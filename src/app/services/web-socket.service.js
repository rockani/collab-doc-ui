...
let WebSocketService = (() => {
    ...
    var WebSocketService = _classThis = class {
        constructor() {
            this.socket$ = new webSocket_1.WebSocketSubject(`ws://localhost:8080/ws/document`);
        }
        connect(docId) {
            this.socket$ = new webSocket_1.WebSocketSubject(`ws://localhost:8080/ws/document?docId=${docId}`);
            return this.socket$;
        }
        sendMessage(message) {
